import { TextField, Typography, FormControl, FormLabel, RadioGroup, FormControlLabel, Radio, Button } from '@material-ui/core'
    ...
    return (
        <div className='account'>
            <div className="account-div">
                <Typography variant='h5' style={{ fontWeight: "bold", width: "200px", textAlign: "left", marginTop: "20px", marginLeft: "85px" }}>Create Your PopX Account</Typography>
                <TextField
                    required
                    id="outlined-basic"
                    label="Full Name"
